...
- As stated above, our replication effort will disregard all experiments from the original study except for Experiment 1 [**ENTER REASON HERE**].

- In the original study, "responses were considered outliers if mouse trajectories were three standard deviations outside of the mean AUC of all responses", and were discarded as such. The present replication [**will / will not**] adhere to this line of reasoning because [**ENTER REASON HERE**].
...
- The present replication effort will present participants with a rather small, square start button (64 * 64 px on a 27" screen), whereas the original study implemented an oblong, 2 cm * 5 cm button.
